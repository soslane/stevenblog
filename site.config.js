const CONFIG = {
  ...
  profile: {
    name: "STEVEN",
    image: "/abc.png", // If you want to create your own notion avatar, check out https://notion-avatar.vercel.app
    role: "",
    bio: "一元一串的钵钵鸡",
  ...
  revalidateTime: 14400, // revalidate time for [slug], index
}
